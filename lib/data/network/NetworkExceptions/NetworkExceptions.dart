...
abstract class NetworkExceptions with _$NetworkExceptions {
      ...
      try {
        ...
        if (error is DioError) {
          switch (error.type) {
            ...
            case DioErrorType.response:
              ...
              switch (error.response!.statusCode) {
                ...
                default:
                  ...
                  // print("JOJO s 1212:- " + error.response["message"]);
                  try {
            ...
            default:
              networkExceptions =
                  NetworkExceptions.defaultError("Unexpected error occurred");
          }
  ...
  static String getErrorMessage12(NetworkExceptions networkExceptions) {
    var errorMessage = "";
    networkExceptions.when(notImplemented: () {
      errorMessage = "Not Implemented";
    }, requestCancelled: () {
